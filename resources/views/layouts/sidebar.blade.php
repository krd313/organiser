            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="mdi mdi-view-carousel-outline"></i> <span>@lang('translation.layouts')</span> <span
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><span>@lang('translation.feather')</span> <span class="badge badge-pill bg-info">v4.29.2</span></a>
                            </li>
                            <li class="nav-item">
