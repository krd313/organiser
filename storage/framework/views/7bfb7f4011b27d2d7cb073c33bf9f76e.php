                        ...
                        <table class="table table-centered table-hover align-middle table-nowrap mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#!" class="btn btn-link btn-sm shadow-none">View More <i
                                                class="ri-arrow-right-line align-bottom"></i></a>
                                    </td>
                                </tr>
                                <tr>
        ...
        <div class="col-xxl-8">
            <div class="card card-height-100">
                    ...
                    <div class="row g-0 text-center">
                        <div class="col-6 col-sm-3">
                            <div class="p-3 border border-dashed border-start-0">
                                <h5 class="mb-1 fs-17 fw-semibold"><span class="counter-value"
                ...
                <div class="card-body p-0 pb-2">
                    <div class="w-100">
                        <div id="line_chart_dashed" data-colors='["--vz-success", "--vz-primary", "--vz-secondary"]'
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/zone/resources/views/dashboard-job.blade.php ENDPATH**/ ?>